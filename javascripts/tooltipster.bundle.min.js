/*! tooltipster v4.1.4 */ ! function(a, b) {
    ...
    i.prototype = {
        ...
        __init: function(b) {
            this.__$tooltip = b, this.__$tooltip.css({
                ...
                position: "absolute",
                top: 0
            }).find(".tooltipster-content").css("overflow", "auto"), this.$container = a('<div role="log" class="tooltipster-ruler"></div>').append(this.__$tooltip).appendTo("body")
        },
    ...
    return a.tooltipster._plugin({
        ...
        instance: {
            ...
            __create: function() {
                var b = a('<div role="tooltip" class="tooltipster-base tooltipster-sidetip"><div class="tooltipster-box"><div class="tooltipster-content"></div></div><div class="tooltipster-arrow"><div class="tooltipster-arrow-uncropped"><div class="tooltipster-arrow-border"></div><div class="tooltipster-arrow-background"></div></div></div></div>');
